import{g as f,S as h,i as _,a as S,b as q,c as m,h as A,r as k,d as x,e as E,j as P,f as y}from"./format-DrM1yZVW.js";f.registerPlugin(h);const p={hero:"https://images.unsplash.com/photo-1519741497674-611481863552?auto=format&fit=crop&w=1600&q=80",about:"https://images.unsplash.com/photo-1606216794074-735e91aa2c92?auto=format&fit=crop&w=1200&q=75",gallery:["https://images.unsplash.com/photo-1511285560929-80b456fea0bc?auto=format&fit=crop&w=800&q=75","https://images.unsplash.com/photo-1465495976277-4387d4b0b4c6?auto=format&fit=crop&w=600&q=75","https://images.unsplash.com/photo-1583939003579-730e3918a45a?auto=format&fit=crop&w=800&q=75","https://images.unsplash.com/photo-1591604129939-f1efa4d9f7fa?auto=format&fit=crop&w=600&q=75","https://images.unsplash.com/photo-1522673607200-164d1b6ce486?auto=format&fit=crop&w=800&q=75","https://images.unsplash.com/photo-1507504031003-b417219a0fde?auto=format&fit=crop&w=600&q=75"]},b=[{num:"01",name:"Full Planning",desc:"End-to-end design and coordination from first vision to last dance."},{num:"02",name:"Partial Planning",desc:"Six months of refined guidance when you need an expert partner."},{num:"03",name:"Design & Styling",desc:"Visual direction, florals, stationery, and every aesthetic detail."},{num:"04",name:"Day Coordination",desc:"Seamless execution so you are present for every moment."}],W=window.__LEAD__||{business_name:"Atelier Blanc",location:"New York, NY",copywriting:{hero_headline:"Love, Curated.",hero_subheadline:"Bespoke wedding planning for the discerning couple.",problem_text:"Your wedding deserves more than a template.",about_text:"We design weddings as we design art — with intention, with restraint, with an eye for the detail no one else sees. Twelve years. Four hundred couples. Zero weddings that look alike.",services_intro:"Every love story is singular. Your wedding should be too.",cta_text:"Begin Your Story",testimonials_intro:"5.0 from couples who trusted us with their most important day."},design_system:{palette:["#3B2A33","#A68A4E","#F7EFE9","#FDF8F5","#3B2A33"]},media:{hero:[],gallery:[],about:[]},reviews:[{author:"Sophie & James",text:"Atelier Blanc did not plan our wedding. They composed it.",rating:5},{author:"Claire M.",text:"Every detail was intentional. Every moment felt inevitable.",rating:5}],rating:5,user_ratings_total:200,phone:"+1 212 555 0199",phone_href:"tel:+12125550199",address:"110 Greene Street, New York, NY 10012"},n=e=>String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;");function w(e,t="#"){if(!e)return t;const s=String(e).trim();return s.startsWith("tel:")||s.startsWith("https:")||s.startsWith("http:")||s==="#"?s:t}const o=(e,t,s)=>{const r=t.split(".").reduce((a,i)=>a==null?a:a[i],e);return r==null||r===""?s:r},$=e=>{const t=Math.round(Number(e)||0);return"★".repeat(Math.max(0,Math.min(5,t)))+"☆".repeat(Math.max(0,5-t))},g=(e,t)=>Array.isArray(e)&&e.length?e[0]:t;function B(e){var s;const t=(s=e.design_system)==null?void 0:s.palette;if(Array.isArray(t)&&t.length>=5){const r=document.documentElement;r.style.setProperty("--color-1",t[0]),r.style.setProperty("--color-2",t[1]),r.style.setProperty("--color-3",t[2]),r.style.setProperty("--color-4",t[3]),r.style.setProperty("--color-5",t[4])}}function C(e){const t=n(o(e,"business_name","Wedding Planner")),s=n(o(e,"copywriting.cta_text","Begin Your Story"));return`
  ...
  </nav>`}function M(e){const t=n(y(o(e,"location",""))),s=n(o(e,"copywriting.hero_headline","Love, Curated.")),r=n(o(e,"copywriting.hero_subheadline","Bespoke wedding planning for the discerning couple.")),a=n(o(e,"copywriting.cta_text","Begin Your Story")),i=n(g(o(e,"media.hero",[]),p.hero)),c=Number(o(e,"rating",0)),l=Number(o(e,"user_ratings_total",0)),d=c?`<div class="hero-rating">
         <span class="stars" aria-hidden="true">${$(c)}</span>
  ...
  </section>`}function L(e){const t=n(o(e,"copywriting.services_intro","Every love story is singular. Your wedding should be too.")),s=o(e,"sections.services",null),a=(Array.isArray(s)&&s.length?s:b).map(i=>`
  ...
  <section class="gallery-section" id="gallery">
    ...
    <div class="masonry-grid">${(Array.isArray(t)&&t.length?t:p.gallery).slice(0,6).map((a,i)=>`
    <figure class="masonry-item">
      <img src="${n(a)}" alt="Wedding moment ${i+1}" loading="lazy" decoding="async" />
    </figure>`).join("")}</div>
  </section>`}function T(e){const t=o(e,"rating",5),s=Number(o(e,"user_ratings_total",0)),r=o(e,"reviews",[]);let a=null;Array.isArray(r)&&r.length&&(a=[...r].sort((l,d)=>(Number(d.rating)||0)-(Number(l.rating)||0)||String(d.text||"").length-String(l.text||"").length)[0]);const i=n((a==null?void 0:a.text)||o(e,"copywriting.testimonials_intro","A celebration unlike any other.")),c=a!=null&&a.author?n(a.author):n(o(e,"business_name","A couple"));return`
  <section class="proof-section" id="proof">
    <p class="proof-stars" aria-hidden="true">${$(t)}</p>
  ...
  </section>`}function j(e){const t=e.copywriting||{},s=n(y(e.location)||"your city"),r=t.cta_headline?n(t.cta_headline):`Your wedding story begins in ${s}.`,a=n(t.cta_text||"Begin Your Story"),i=w(e.phone_href);return`
  ...
  <footer class="site-footer" id="contact">
    <div class="footer-grid">
      ...
      <div class="footer-col">
        ...
        ${s?`<p>${s}</p>`:i?`<p>${i}</p>`:""}
        ${r?`<p><a href="${a}">${r}</a></p>`:""}
        <a class="footer-maps-link" href="${H(e)}" target="_blank" rel="noopener">Get Directions ↗</a>
  ...
  </footer>`}function O(e){B(e);const t=g(o(e,"media.hero",[]),p.hero),s=document.getElementById("hero-preload");s&&t&&s.setAttribute("href",t);const r=document.querySelector("#main"),a=document.createElement("div");a.innerHTML=C(e).trim();const i=a.firstElementChild;return i&&document.body.insertBefore(i,r),r.innerHTML=[M(e),I(e),L(e),Y(e),N(e),T(e),j(e),F(e)].join(""),i}function R(e){const t=window.matchMedia("(prefers-reduced-motion: reduce)").matches;_(),S(".js-cursor"),q(".btn");let s=[];const r=document.querySelector(".hero-title");if(r&&typeof m=="function"){const i=m({target:r,by:"chars"});s=i&&i[0]&&i[0].chars||r.querySelectorAll(".char")}if(!t){const i=f.timeline();s&&s.length&&i.from(s,{yPercent:110,opacity:0,duration:.8,stagger:.03,ease:"power3.out"}),i.from([".hero-kicker",".hero-sub",".hero-rating",".hero-cta-row"],{y:40,opacity:0,duration:.7,stagger:.1,ease:"power2.out"},"-=0.3")}A(".hero-img",".hero"),k("[data-reveal]",{y:60,duration:.7}),x(".service-item",{duration:.5,stagger:.06});const a=document.querySelector(".hero");e&&a&&"IntersectionObserver"in window&&new IntersectionObserver(([c])=>{e.classList.toggle("scrolled",!c.isIntersecting)},{rootMargin:"-80px 0px 0px 0px",threshold:0}).observe(a),document.fonts&&document.fonts.ready&&document.fonts.ready.then(()=>{E(".services-title, .gallery-title, .cta-headline, .services-eyebrow"),P(".story-pull-quote, .proof-quote"),h.refresh()}),window.addEventListener("load",()=>h.refresh())}function v(){const e=O(W);R(e)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",v):v();
